...
<div class="row">
    <div class="col-sm-4">
        <div class="">
            <img src="img/about/avt2.png" class="rounded img2" alt="avt">
        </div>
    </div>
    ...
    <div class="col-sm-8">
        <div class="information">
            <div>
                ...
                <h3 class="bolder">Tran Thi Sa</h3>
                <p class="dark-gray">"Hello, my name is Tran Thi Sa. I'm 20 years old. I'm a Web developer form Nomg Lam University"</p>
            </div>
            <div>
                <div class="row">
                    <div class="col-sm-6">
                    ...
                    <div class="col-sm-6">
                        <h4>Certificates</h4>
                        <p class="dark-gray">2019 - graduated at Tieu La Secondary School<br>
                            2021 - studying at Nong Lam university</p>
                        </br>
                        <h4>Contact Information</h4>
                        <div class="row">
                            <div class="col-sm-1"><i class="fas fa-map-marker-alt" style="color: #ad9463"></i></div>
                            <div class="col-sm-11 dark-gray">Pleiku City</div>
                        </div>
                        <div class="row">
                            <div class="col-sm-1"><i class="fas fa-phone-volume" style="color: #ad9463"></i></div>
                            <div class="col-sm-11 dark-gray">0966969184</div>
                        </div>
                    </div>
                </div>
            </div>
            <div class="" style="margin-top: 25px">
                ...
                <div class="progress" style="height: 25px">
                    <div class="progress-bar bg-secondary" style="width:70%">HTML</div>
                </div>
                </br>
                <div class="progress" style="height: 25px">
                    <div class="progress-bar bg-secondary" style="width:60%">CSS</div>
                </div>
                </br>
                <div class="progress" style="height: 25px">
                    <div class="progress-bar bg-secondary" style="width:90%">JS</div>
                </div>
                </br>
                <div class="progress" style="height: 25px">
