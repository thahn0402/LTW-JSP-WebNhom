            ...
            <div class="col-sm-12">
                <div class="card-box">
                    ...
                    <div class="card-body row">
                        ...
                        <div class="col-sm-12 col-md-6 padding">
                            <label for="" class="label">City</label><br>
                            <input type="text" name="city">
                        </div>
                        <div class="col-sm-12 col-md-6 padding">
                            <label for="" class="label">Arrive</label><br>
                            <input type="date" name="arrive">
                        </div>
                        <div class="col-sm-12 col-md-6 padding">
                            <label for="" class="label">Depart</label><br>
                            <input type="date" name="depart">
                        </div>
                        <div class="col-sm-12 col-md-6 padding">
                            <label for="" class="label">No of persons</label><br>
                        ...
                        <div class="col-sm-12 col-md-6 padding">
                            <label for="" class="label">Room type</label><br>
                        ...
                        <div class="col-sm-12 padding">
                            <label for="" class="label">Comment</label><br>
