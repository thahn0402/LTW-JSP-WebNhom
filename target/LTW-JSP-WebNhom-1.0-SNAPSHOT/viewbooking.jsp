                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-6 col-sm-6">
                                <div class="btn-group">
                                    <a href="newbooking.html">ADD NEW<i class="icon ti-plus"></i></a>
                                </div>
                            </div>
                            <div class="col-md-6 col-sm-6">
                            ...
                            <div class="table-responsive">
                                <table class="table table-hover mb-0" style="text-align: center;">
                                    ...
                                    <tr>
                                        ...
                                        <th class="th-lg"><a>Arrive<i class="fas fa-sort ml-1"></i></a></th>
                                        <th class="th-lg"><a>Depart<i class="fas fa-sort ml-1"></i></a></th>
                                        <th class="th-lg"><a>Room Type<i class="fas fa-sort ml-1"></i></a></th>
