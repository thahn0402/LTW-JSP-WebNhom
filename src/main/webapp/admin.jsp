            ...
            <ul class="custom-scrollbar">
                ...
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu">
                        ...
                        <a class="dropdown-item" href="room.jsp">View all rooms</a>
                        <a class="dropdown-item" href="addroom.jsp">Edit room details</a>
                    </div>
                </li>
                <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle" href="#" data-toggle="dropdown">
                    ...
                    <div class="dropdown-menu">
                        <a class="dropdown-item" href="newbooking.jsp">New booking</a>
                        <a class="dropdown-item" href="viewbooking.jsp">View booking</a>
                    </div>
                </li>
                <li class="nav-item">
