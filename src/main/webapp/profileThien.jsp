...
<div class="row">
    <div class="col-sm-4">
        <div class="">
            <img src="img/about/avt3.png" class="rounded img2" alt="avt">
        </div>
    </div>
    ...
    <div class="col-sm-8">
        <div class="information">
            <div>
                ...
                <h3 class="bolder">Nguyen Cao Tri Thien</h3>
                <p class="dark-gray">"Hello, my name is Thien. I'm 20 years old. I'm a Web developer form Nomg Lam University.""</p>
            </div>
            <div>
                <div class="row">
                    <div class="col-sm-6">
                    ...
                    <div class="col-sm-6">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-11 dark-gray">0583309687</div>
                        </div>
                    </div>
                </div>
            </div>
